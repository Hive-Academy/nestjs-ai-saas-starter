...
- **File**: `D:\projects\nestjs-ai-saas-starter\libs\langgraph-modules\memory\src\lib\interfaces\vector-service.interface.ts`
...
- **File**: `D:\projects\nestjs-ai-saas-starter\libs\langgraph-modules\memory\src\lib\interfaces\graph-service.interface.ts`
...
- **File**: `D:\projects\nestjs-ai-saas-starter\libs\langgraph-modules\memory\src\lib\adapters\chroma-vector.adapter.ts`
...
export class ChromaVectorAdapter extends IVectorService {
  ...
  constructor(private readonly chromaDB: ChromaDBService, private readonly config: VectorAdapterConfig) {
    super();
  }
...
- **File**: `D:\projects\nestjs-ai-saas-starter\libs\langgraph-modules\memory\src\lib\adapters\neo4j-graph.adapter.ts`
...
- **File**: `D:\projects\nestjs-ai-saas-starter\libs\langgraph-modules\memory\src\lib\memory.module.ts` (modify existing)
...
- **Files**:
  - `D:\projects\nestjs-ai-saas-starter\libs\langgraph-modules\memory\src\lib\services\memory-storage.service.ts` (modify)
  - `D:\projects\nestjs-ai-saas-starter\libs\langgraph-modules\memory\src\lib\services\memory-graph.service.ts` (modify)
