...
@Component({
  ...
  template: `
    <div class="relative w-full bg-gradient-to-b from-white via-purple-50/30 to-white overflow-hidden">
      <!-- Content Container -->
      <div class="container mx-auto px-8 py-12">
        ...
        >
          <span class="inline-flex items-center gap-2 px-6 py-2 bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-full text-sm font-semibold text-purple-700 mb-6">
        ...
        >
          <div class="text-center">
            <div class="text-4xl font-bold text-indigo-600 mb-2">17 Fields</div>
            <div class="text-sm text-gray-500 uppercase tracking-wide">WorkflowState Interface</div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-purple-600 mb-2">Zero 'any'</div>
            <div class="text-sm text-gray-500 uppercase tracking-wide">Type Safety</div>
          </div>
          <div class="text-center">
            <div class="text-4xl font-bold text-pink-600 mb-2">10+ Modules</div>
            <div class="text-sm text-gray-500 uppercase tracking-wide">Foundation For</div>
          </div>
        </div>
        </div>
      </div>
                ...
                <div class="grid lg:grid-cols-2 gap-16 items-center">
                  ...
                  >
                    <div class="inline-flex items-center gap-3 mb-6">
                      <span class="flex items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-purple-500 to-pink-600 text-white font-bold text-lg shadow-lg">
                        {{ step.step }}
                      </span>
                      <div class="h-px flex-1 bg-gradient-to-r from-purple-200 to-transparent max-w-[100px]"></div>
                    </div>
            ...
            <div class="max-w-5xl mx-auto py-6">
              ...
              <div class="grid grid-cols-3 gap-4">
                @for (integration of integrations(); track integration.name; let i = $index) {
                  <div class="bg-white/95 backdrop-blur-sm rounded-xl p-4 border border-purple-100 hover:shadow-lg transition-all duration-300 animate-fade-in-up" [style.animation-delay]="(i * 100) + 'ms'">
