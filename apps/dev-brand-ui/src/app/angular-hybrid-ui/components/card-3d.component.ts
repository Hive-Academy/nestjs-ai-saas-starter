...
export class Card3DComponent implements OnInit {
  ...
  @Output() click = new EventEmitter<HybridElement3D>();
   ...
   */
  onElement3DHover(element: HybridElement3D): void {
   ...
   */
  onElement3DClick(element: HybridElement3D): void {
   ...
   */
  private getDefaultGeometry(): NonNullable<HybridElementConfig['decoration']>['geometry'] {
    switch (this.priority) {
      case 'HERO': return 'icosahedron';
      case 'PRIMARY': return 'sphere';
      case 'SECONDARY': return 'cube';
      case 'TERTIARY': return 'cylinder';
  ...
  private getDefaultColor(): number {
    switch (this.priority) {
      case 'HERO': return 0xffd700; // Gold
      case 'PRIMARY': return 0x3b82f6; // Blue
      case 'SECONDARY': return 0x6b7280; // Gray
      case 'TERTIARY': return 0x9ca3af; // Light Gray
   ...
   */
  private normalizedDecoration(): NonNullable<HybridElementConfig['decoration']> {
    const base = {
