...
export const AGENT_CAPABILITIES: Record<AgentType, AgentCapability> = {
  [AgentType.RESEARCHER]: {
    ...
    skills: ['web_search', 'data_analysis', 'fact_checking', 'source_verification'],
  ...
  [AgentType.ANALYST]: {
    ...
    skills: ['data_analysis', 'statistical_analysis', 'trend_identification', 'reporting'],
  ...
  [AgentType.REVIEWER]: {
    ...
    skills: ['quality_assessment', 'error_detection', 'compliance_checking', 'feedback_generation'],
  ...
  [AgentType.DATA_SCIENTIST]: {
    ...
    description: 'Specializes in advanced data science and machine learning tasks',
    skills: ['machine_learning', 'statistical_modeling', 'data_visualization', 'predictive_analysis'],
  ...
  [AgentType.SENIOR_DEVELOPER]: {
    ...
    skills: ['advanced_programming', 'code_review', 'mentoring', 'system_design'],
  ...
  [AgentType.ARCHITECT]: {
    ...
    skills: ['system_design', 'architecture_patterns', 'scalability_planning', 'technology_selection'],
  ...
  [AgentType.FINANCIAL_ANALYST]: {
    ...
    skills: ['financial_modeling', 'market_analysis', 'risk_assessment', 'investment_analysis'],
  ...
  [AgentType.LEGAL_ADVISOR]: {
    ...
    skills: ['legal_research', 'contract_analysis', 'compliance_checking', 'legal_writing'],
  ...
  [AgentType.MEDICAL_EXPERT]: {
    ...
    skills: ['medical_research', 'diagnosis_support', 'treatment_analysis', 'drug_interaction'],
  ...
  [AgentType.MARKETING_SPECIALIST]: {
    ...
    skills: ['market_research', 'campaign_planning', 'content_marketing', 'analytics'],
  ...
  [AgentType.ML_ENGINEER]: {
    ...
    skills: ['model_development', 'ml_pipeline', 'model_deployment', 'performance_optimization'],
  ...
  [AgentType.AI_TRAINER]: {
    ...
    skills: ['model_training', 'hyperparameter_tuning', 'data_preparation', 'training_optimization'],
    tools: ['training_frameworks', 'hyperparameter_optimizer', 'data_preprocessor'],
  },
  ...
  [AgentType.MODEL_EVALUATOR]: {
    ...
    skills: ['model_evaluation', 'performance_metrics', 'bias_detection', 'validation_testing'],
  ...
  [AgentType.ASSISTANT]: {
    ...
    skills: ['task_management', 'information_retrieval', 'basic_analysis', 'communication'],
  ...
  [AgentType.COORDINATOR]: {
    ...
    skills: ['workflow_management', 'agent_coordination', 'task_delegation', 'progress_tracking'],
  ...
  [AgentType.SUPERVISOR]: {
    ...
    skills: ['quality_oversight', 'performance_monitoring', 'decision_making', 'escalation_handling'],
