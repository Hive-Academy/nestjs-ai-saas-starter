...
export class MemoryStorageError extends MemoryError {
  constructor(message: string, context: Omit<MemoryErrorContext, 'service'>, cause?: Error) {
   ...
   */
  static documentStorage(operation: string, threadId: string, cause: Error): MemoryStorageError {
   ...
   */
  static documentRetrieval(operation: string, threadId: string, cause: Error): MemoryStorageError {
    return new MemoryStorageError(
   ...
   */
  static searchOperation(operation: string, query: string, cause: Error): MemoryStorageError {
    return new MemoryStorageError(
   ...
   */
  static collectionManagement(operation: string, collectionName: string, cause: Error): MemoryStorageError {
    return new MemoryStorageError(
...
export class MemoryRelationshipError extends MemoryError {
   ...
   */
  static graphStorage(operation: string, threadId: string, memoryId: string, cause: Error): MemoryRelationshipError {
   ...
   */
  static relationshipQuery(operation: string, threadId: string, cause: Error): MemoryRelationshipError {
    return new MemoryRelationshipError(
   ...
   */
  static schemaInitialization(operation: string, cause: Error): MemoryRelationshipError {
    return new MemoryRelationshipError(
   ...
   */
  static transactionFailure(operation: string, threadId: string, cause: Error): MemoryRelationshipError {
    return new MemoryRelationshipError(
...
export class MemoryEmbeddingError extends MemoryError {
   ...
   */
  static embeddingGeneration(operation: string, textCount: number, cause: Error): MemoryEmbeddingError {
   ...
   */
  static providerConfiguration(operation: string, provider: string, cause: Error): MemoryEmbeddingError {
    return new MemoryEmbeddingError(
   ...
   */
  static apiFailure(operation: string, provider: string, cause: Error): MemoryEmbeddingError {
    return new MemoryEmbeddingError(
...
export class MemorySummarizationError extends MemoryError {
   ...
   */
  static llmApiFailure(operation: string, provider: string, threadId: string, cause: Error): MemorySummarizationError {
   ...
   */
  static strategyFailure(operation: string, strategy: string, threadId: string, cause: Error): MemorySummarizationError {
    return new MemorySummarizationError(
   ...
   */
  static configurationError(operation: string, issue: string): MemorySummarizationError {
    return new MemorySummarizationError(
      'Summarization configuration error',
      {
        operation,
        timestamp: new Date(),
...
export class MemoryConfigurationError extends MemoryError {
   ...
   */
  static invalidConfiguration(operation: string, configPath: string, issue: string): MemoryConfigurationError {
    return new MemoryConfigurationError(
      'Invalid memory module configuration',
      {
        operation,
        timestamp: new Date(),
   ...
   */
  static missingConfiguration(operation: string, requiredConfig: string): MemoryConfigurationError {
    return new MemoryConfigurationError(
...
export function wrapMemoryError(
  ...
  switch (service) {
    case 'chromadb':
      return new MemoryStorageError('ChromaDB operation failed', context, cause);
    case 'neo4j':
      return new MemoryRelationshipError('Neo4j operation failed', context, cause);
    case 'embedding':
      return new MemoryEmbeddingError('Embedding operation failed', context, cause);
    case 'summarization':
      return new MemorySummarizationError('Summarization operation failed', context, cause);
    default:
      return new MemoryError('Memory operation failed', context, cause) as MemoryError;
  }
}
