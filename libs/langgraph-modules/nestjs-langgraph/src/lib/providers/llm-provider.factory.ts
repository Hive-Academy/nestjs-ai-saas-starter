...
export class LLMProviderFactory {
  ...
  private createOpenAI(config: LLMProviderConfig): BaseChatModel {
    ...
    this.logger.log(
      `Created OpenAI provider with model: ${
  ...
  private createAnthropic(config: LLMProviderConfig): BaseChatModel {
    ...
    this.logger.log(
      `Created Anthropic provider with model: ${
  ...
  private createGoogle(config: LLMProviderConfig): BaseChatModel {
    ...
    this.logger.log(
      `Created Google provider with model: ${config.model || 'gemini-1.5-pro'}`
    );
    return model;
  }
  ...
  private createAzure(config: LLMProviderConfig): BaseChatModel {
    ...
    this.logger.log(
      `Created Azure OpenAI provider with deployment: ${config.model}`
    );
    return model;
  }
